...
_computedKey = Service.init, _dec = Remote("status"), _dec1 = Remote("adapters"), _dec2 = Remote("refresh"), _dec3 = Remote("daemon-start"), _dec4 = Remote("settings"), _dec5 = Remote("approval-set"), _dec6 = Remote("adapter-disable"), _dec7 = Remote("login-check"), _dec8 = Remote("adapter-detail"), _dec9 = Remote("schedule-add"), _dec10 = Remote("schedule-list"), _dec11 = Remote("ingest-events"), _dec12 = Remote("audit-list"), _dec13 = Remote("logs-tail"), _dec14 = Remote("schedule-run-now"), _dec15 = Remote("schedule-history"), _dec16 = Remote("schedule-toggle"), _dec17 = Remote("schedule-remove"), _dec18 = Remote("try-run"), _dec19 = Remote("replay"), _dec20 = Remote("script-catalog"), _dec21 = Remote("script-run-builtin"), _dec22 = Remote("crawl"), _dec23 = Remote("script-validate"), _dec24 = Remote("userscript-run"), _dec25 = Remote("recipe-run"), _dec26 = Remote("automation-search"), _dec27 = Remote("automation-develop"), _dec28 = Remote("automation-run"), _dec29 = Remote("automation-mode-get"), _dec30 = Remote("automation-mode-set"), _dec31 = Remote("promote-recording"), _dec32 = Remote("install-opencli-skill"), _dec33 = Remote("rulepacks-list"), _dec34 = Remote("rulepacks-set");
