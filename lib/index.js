...
_computedKey = Service.init, _dec = Remote("status"), _dec1 = Remote("adapters"), _dec2 = Remote("refresh"), _dec3 = Remote("daemon-start"), _dec4 = Remote("settings"), _dec5 = Remote("approval-set"), _dec6 = Remote("adapter-disable"), _dec7 = Remote("login-check"), _dec8 = Remote("adapter-detail"), _dec9 = Remote("schedule-add"), _dec10 = Remote("schedule-list"), _dec11 = Remote("ingest-events"), _dec12 = Remote("schedule-run-now"), _dec13 = Remote("schedule-history"), _dec14 = Remote("schedule-toggle"), _dec15 = Remote("schedule-remove"), _dec16 = Remote("try-run"), _dec17 = Remote("replay"), _dec18 = Remote("script-catalog"), _dec19 = Remote("script-run-builtin"), _dec20 = Remote("crawl"), _dec21 = Remote("script-validate"), _dec22 = Remote("userscript-run"), _dec23 = Remote("recipe-run"), _dec24 = Remote("automation-search"), _dec25 = Remote("automation-develop"), _dec26 = Remote("automation-run"), _dec27 = Remote("automation-mode-get"), _dec28 = Remote("automation-mode-set"), _dec29 = Remote("promote-recording"), _dec30 = Remote("install-opencli-skill"), _dec31 = Remote("rulepacks-list"), _dec32 = Remote("rulepacks-set");
...
${r.stderr}`.trim();
  ...
  async ingestEvents() {
    return {
      ok: true,
      events: this.ingestEvents.slice(0, 30)
    };
  }
