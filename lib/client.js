window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		${runOut.text}`);
		      ...
		      }, t2("rerun")))) : null, (0, import_react.createElement)("div", {
		        className: "o4-micro"
		      }, (0, import_react.createElement)("div", {
		        className: "o4-mst load"
		      }, (0, import_react.createElement)("b", null, t2("loading")), (0, import_react.createElement)("div", {
		        className: "bar",
		        style: {
		          width: "80%"
		        }
		      ...
		      }), "\u9AA8\u67B6\u5C4F,\u6309\u94AE\u7981\u7528"), (0, import_react.createElement)("div", {
		        className: "o4-mst ok"
		      }, (0, import_react.createElement)("b", null, "OK"), t2("copy") + " / " + t2("rerun")), (0, import_react.createElement)("div", {
		        className: "o4-mst err"
		      }, (0, import_react.createElement)("b", null, "ERR"), t2("needLogin"), " ", (0, import_react.createElement)("span", {
		        className: "fix"
		      }, t2("fix") + " \u2197")))),
		      // 快捷 + 巡检
		      (0, import_react.createElement)("div", {
		...
		${c.description}`,
		  ...
		  const renderAutomation = () => {
		    return (0, import_react.createElement)("div", null, (0, import_react.createElement)("div", {
		      ...
		      return (0, import_react.createElement)("div", {
		        ...
		        className: "o4-tt"
		      }, s.site), (0, import_react.createElement)("div", {
		        className: "o4-dd"
		      }, `${t2("last")}: ${hist[0]?.at?.slice(5, 16) ?? "\u2014"} \xB7 ${hist.filter((h) => h.ok).length}/${hist.length || 0}`)), (0, import_react.createElement)("span", {
		        className: "o4-hpts"
		      }, dots), (0, import_react.createElement)("span", {
		        className: "o4-cron"
		      }, s.cron), (0, import_react.createElement)("span", {
		        className: "o4-bdg b"
		      }, t2("retryN")(s.retry ?? 3)), (0, import_react.createElement)("span", {
		        className: "o4-bdg"
		      }, s.notify === false ? t2("notifyOff") : t2("notifyOn")), (0, import_react.createElement)("button", {
		        className: "o4-btn ghost sm",
		        onClick: () => {
		  ...
		  return (0, import_react.createElement)("div", null, (0, import_react.createElement)("div", {
		    ...
		    (0, import_react.createElement)("div", {
		      ...
		      className: "o4-logo"
		    }, ic("brand")), (0, import_react.createElement)("div", null, (0, import_react.createElement)("div", {
		      className: "o4-h1"
		      ...
		      className: "o4-vchip"
		    }, "v0.4.0"), (0, import_react.createElement)("div", {
		      className: "o4-seg"
		    }, (0, import_react.createElement)("button", {
		    ...
		    }), "daemon ", daemonUp ? t2("daemonRunning") : t2("daemonDown")), (0, import_react.createElement)("span", {
		      className: "o4-chip"
		    }, (0, import_react.createElement)("span", {
		      className: "o4-dot g"
		    }), "BrowserBridge ", t2("bridgeOn")), (0, import_react.createElement)("span", {
		      className: "o4-chip"
		    }, ic("monitor", true), "Chrome"), (0, import_react.createElement)("span", {
		      className: "o4-sep"
