window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// dsh-plugin/plugins/dsh-opencli/.build-tools/tmp-src/client.js
		var client_exports = {};
		...
		function Panel() {
		  ...
		  const replayRecording = async (id) => {
		    ...
		    for (const step of r.steps) {
		      ...
		      if (cmd === void 0 || cmd.length === 0) continue;
		  ...
		  return (0, import_react.createElement)(
		    ...
		    }, "\u666E\u901A\u4EBA 3 \u51FB\u5F00\u7BB1\uFF080 \u914D\u7F6E\uFF09"), (0, import_react.createElement)("div", {
		      style: {
		        display: "grid",
		    ...
		    }, "\u{1F441}\uFE0F \u770B\u70ED\u699C"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u7528\u5904\uFF1A\u77E5\u4E4E\u4ECA\u5929\u70ED\u699C\u524D10"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u6548\u679C\uFF1A\u7ED3\u6784\u5316\u699C\u5355\u8F6C\u6458\u8981"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u600E\u4E48\u7528\uFF1A\u5BF9 agent \u8BF4\u201C\u77E5\u4E4E\u70ED\u699C\u524D10\u6458\u8981\u201D"), (0, import_react.createElement)("div", {
		      className: "ocp-code",
		      style: {
		        marginTop: "6px"
		      }
		    }, "site zhihu hot")), (0, import_react.createElement)("div", {
		      className: "ocp-use",
		      style: {
		        border: "1px solid rgba(255,255,255,.06)",
		        borderRadius: "12px",
		    ...
		    }, "\u{1F50D} \u641C\u89C6\u9891"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u7528\u5904\uFF1AB\u7AD9\u641C\u7F57\u7FD4"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u6548\u679C\uFF1A\u64AD\u653E\u91CF\u524D3 + \u94FE\u63A5"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u600E\u4E48\u7528\uFF1A\u641C\u201Cbilibili\u201D\u2192 \u70B9 search"), (0, import_react.createElement)("div", {
		      className: "ocp-code",
		      style: {
		        marginTop: "6px"
		      }
		    }, "site bilibili search \u7F57\u7FD4")), (0, import_react.createElement)("div", {
		      className: "ocp-use",
		      style: {
		        border: "1px solid rgba(255,255,255,.06)",
		        borderRadius: "12px",
		    ...
		    }, "\u{1F4E4} \u53D1\u52A8\u6001"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u7528\u5904\uFF1A\u628A\u8FD9\u4E2A\u53D1\u6211\u5FAE\u535A"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u6548\u679C\uFF1A\u5728\u4F60\u7684\u53F7\u771F\u5B9E\u53D1\u5E03"), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u600E\u4E48\u7528\uFF1A\u8BF4\u201C\u53D1\u6211\u5FAE\u535A\u201D\u2192 \u5BA1\u6279\u7A97\u70B9\u5141\u8BB8"), (0, import_react.createElement)("div", {
		      className: "ocp-code",
		      style: {
		        marginTop: "6px"
		      }
		    ...
		    (0, import_react.createElement)("div", {
		      ...
		      className: "ocp-setup-t"
		    }, "\u5F55\u5236\u56DE\u653E"), (0, import_react.createElement)("span", {
		      className: "ocp-hint"
		    }, `${recordings.length} \u6761`), (0, import_react.createElement)("button", {
		      className: "ocp-btn ocp-btn-sm",
		      onClick: () => {
		        if (isRecording) stopRecording();
		        else startRecording();
		      }
		    }, isRecording ? "\u505C\u6B62\u5F55\u5236" : "\u5F00\u59CB\u5F55\u5236")), isRecording ? (0, import_react.createElement)("div", {
		      style: {
		        display: "flex",
		      ...
		      className: "ocp-hint"
		    }, `\u5DF2\u5F55 ${recordSteps.length} \u6B65`)), (0, import_react.createElement)("div", {
		      className: "ocp-srow"
		    }, (0, import_react.createElement)("input", {
		      className: "ocp-input",
		      style: {
		      ...
		      className: "ocp-hint"
		    }, `${r.steps.length}\u6B65 \xB7 ${new Date(r.createdAt).toLocaleDateString()}`), (0, import_react.createElement)("button", {
		      className: "ocp-btn ocp-btn-sm",
		      onClick: () => {
		        void replayRecording(r.id);
		      }
		    }, "\u56DE\u653E"), (0, import_react.createElement)("button", {
		      className: "ocp-btn ocp-btn-sm",
		      onClick: () => {
		    ...
		    }, "\u6682\u65E0\u5F55\u5236\u3002\u70B9\u51FB\u201C\u5F00\u59CB\u5F55\u5236\u201D\u540E\uFF0C\u4F60\u7684 browser_* / site \u8C03\u7528\u4F1A\u81EA\u52A8\u8FFD\u52A0\u4E3A\u6B65\u9AA4\uFF08MVP\uFF1A\u624B\u52A8\u5728\u4E0B\u65B9\u8F93\u5165\u6B65\u9AA4\uFF09"), (0, import_react.createElement)("div", {
		      className: "ocp-srow",
		      style: {
		      ...
		      className: "ocp-setup-t"
		    }, "\u5B9A\u65F6\u8BA2\u9605"), (0, import_react.createElement)("span", {
		      className: "ocp-hint"
		    }, "dsh.schedule")), (0, import_react.createElement)("div", {
		      className: "ocp-srow"
		    }, (0, import_react.createElement)("input", {
		      className: "ocp-input",
		      style: {
		    ...
		    }, "\u521B\u5EFA")), (0, import_react.createElement)("div", {
		      className: "ocp-hint"
		    }, "\u521B\u5EFA\u540E\u53EF\u5728 dsh schedule list \u67E5\u770B\u3002\u672C\u5730\u9002\u914D\u5668\u53EF\u5728\u4E0B\u65B9\u201CSite\u547D\u4EE4\u201D\u4E2D\u901A\u8FC7\u7981\u7528/\u542F\u7528\u7BA1\u7406\uFF0C\u5373\u201C\u6211\u7684\u9002\u914D\u5668\u201D\u3002")),
		    // ── 高级自动化（脚本/配方/泛爬，默认收起）──
		    (0, import_react.createElement)("details", {
		      className: "ocp-adv",
		      open: false
		    }, (0, import_react.createElement)("summary", null, "\u9AD8\u7EA7\u81EA\u52A8\u5316\uFF08\u811A\u672C/\u914D\u65B9/\u6CDB\u722C\uFF09\u2014 \u7ED9\u9700\u8981\u7684\u4EBA"), (0, import_react.createElement)("div", {
		      style: {
		        display: "flex",
		        flexDirection: "column",
		        gap: "12px",
		      ...
		      className: "ocp-sk"
		    }, "\u81EA\u52A8\u5316\u81EA\u7531\u5EA6"), (0, import_react.createElement)("select", {
		      ...
		      value: "read-only"
		    }, "\u53EA\u8BFB"), (0, import_react.createElement)("option", {
		      value: "standard"
		    }, "\u6807\u51C6\uFF08\u9ED8\u8BA4\uFF09"), (0, import_react.createElement)("option", {
		      value: "autonomous"
		    }, "\u81EA\u4E3B"), (0, import_react.createElement)("option", {
		      value: "unrestricted"
		    }, "\u65E0\u4EBA\u503C\u5B88"))), (0, import_react.createElement)("div", {
		      className: "ocp-srow"
		    }, (0, import_react.createElement)("span", {
		      className: "ocp-sk"
		    }, "\u9650\u6D41"), (0, import_react.createElement)("span", {
		      className: "ocp-hint"
		    }, "minDelay 750ms / \u5E76\u53D1 2 / \u7A81\u53D1 3 / \u51B7\u5374 30s"), (0, import_react.createElement)("span", {
		      className: "ocp-tag ocp-tag-read",
		      style: {
		        marginLeft: "auto"
		      }
		    }, "\u5DF2\u542F\u7528")), (0, import_react.createElement)("div", {
		      className: "ocp-srow"
		    }, (0, import_react.createElement)("span", {
		      className: "ocp-sk"
		    }, "\u9650\u57DF\u767B\u5F55"), (0, import_react.createElement)("span", {
		      className: "ocp-hint"
		    }, "authProfiles: allowedDomains \u9650\u57DF\uFF0C\u9ED8\u8BA4\u53EA\u8BFB\u4E0D\u56DE\u5199")), (0, import_react.createElement)("div", {
		      style: {
		        display: "grid",
		    ...
		    }, "\u811A\u672C\u76EE\u5F55"), (0, import_react.createElement)("button", {
		      className: "ocp-btn ocp-btn-sm",
		      onClick: async () => {
