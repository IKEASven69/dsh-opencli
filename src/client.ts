...
/* ── i18n:面板内全部用户可见文案走这里,页头可切 zh/en ── */
const STR = {
  zh: {
    title: 'OpenCLI 管理中心',
    desc: '浏览内置 OpenCLI 命令;dsh 会话经 site 工具直接调用,缺失站点可让模型现场创作。',
    refresh: '刷新/诊断', diagnosing: '检测中…', langName: 'EN',
    s0t: '0. 试试看', s0tag: '立刻能用',
    s0hint: '不知道干嘛?点“我跑一下”,面板经 try-run 真跑一条命令把结果拿回来。',
    s0demo: '我跑一下', s0run: '跑这', s0ph: '想跑什么命令,如:site arxiv recent cs.AI',
    s05t: '0.5 搜站点', s05hint: '点站点 tag 填进搜索框;搜站点名 → 复制 opencli 命令。',
    s05searchPh: '搜索站点、命令或描述', s05cmds: '条命令', s05empty: '没有匹配的站点或命令',
    s05call: 'dsh 会话调用:', s05copyHint: '· 点击行复制完整命令', s05disable: '禁用', s05enable: '启用',
    s05disabled: '已禁用', s05copied: '已复制', s05loading: 'loading…', s05loadFail: '加载失败',
    s05siteCmds: 'Site 命令', s05appCmds: 'App 命令',
    s05siteTitle: '网站适配器——在登录态 Chrome 里执行',
    s05appTitle: '本地桌面应用适配器(Codex/Cursor/Trae 等,经 CDP 操控目标应用;需本机装有对应应用,不依赖 OpenCLIApp)',
    s06t: '0.6 实用快捷', s06tag: '新',
    s06diag: '失败诊断 ?', s06skill: '装 opencli skill', s06patch: '切到 Patchright',
    s06hon: '开 headless', s06hoff: '关 headless', s06ro: '切到 read-only', s06auto: '切到 autonomous',
    s06hint: '点按钮 → 文本复制到剪贴板 + 跳 dsh 对话框,去粘贴发送。失败诊断会先弹窗再跳。',
    s1t: '1. opencli 健康', s1tag: '看一眼',
    s1daemon: 'daemon', s1running: '运行中', s1stopped: '未运行',
    s1start: '启动 daemon', s1starting: '启动中…', s1ext: 'Chrome 扩展',
    s1extOn: '已连接', s1approval: 'write 审批门',
    s1approvalOn: '开启(site 写操作先经确认)', s1approvalOff: '关闭',
    s1on: '开启', s1off: '关闭', s1loginCan: '个站点可巡检', s1login: '登录态',
    s1check: '巡检登录态', s1checking: '巡检中…', s1collapse: '收起',
    s1env: '环境', s1runtime: '运行时', s1mode: '自动化档',
    s1sites: '站点', s1cmds: '命令', s1ver: 'v',
    s1okTag: '正常', s1loginHint: '绿=已登 · 黄=超时 · 红=未登 · 5+ 折叠 · 换登录去 dsh 对话框说“换微博账号”',
    s1timeout: '探测超时', s1checkFail: '巡检失败',
    s2t: '2. 定时任务', s2hint: '新建/改/删 → 去 dsh 对话说“建一个每天9点跑 arxiv 综述”',
    s2sitePh: 'site 命令(如:zhihu hot)', s2cronPh: 'cron', s2create: '创建',
    s2empty: '暂无定时。上面填 site 命令 + cron 点创建,或去 dsh 对话说。创建后可在 dsh schedule list 查看。',
    s2run: '立即跑', s2pause: '关停', s2resume: '启用', s2del: '删',
    s2paused: '已暂停', s2on: '运行中', s2runOk: '已触发', s2hist: '查看运行历史:去 dsh 对话框说“定时历史”',
    s3t: '3. 录制回放', s3hint: '录新/改 → 去 dsh 对话说“录一段:抓 arxiv 今天的 AI 论文”',
    s3start: '开始录制', s3stop: '停止录制', s3namePh: '录制名称(如:每日知乎热榜)',
    s3stepPh: '添加步骤(回车确认,如:site zhihu hot)', s3recorded: '已录',
    s3replay: '回放', s3del: '删除', s3promote: '生成为 recipe',
    s3promoted: '已晋升为 recipe:', s3empty: '暂无录制。点“开始录制”手动输入步骤;真实 Chrome 操作自动追加走 dsh 对话。',
    s3steps: '步', s35t: '3.5 自动化资产库', s35tag: '对齐 anweat',
    s35hint: '新建/激活/归档 → 去 dsh 对话说“新建 recipe”',
    s35searchPh: '搜资产(如:arxiv)', s35search: '搜索', s35run: '运行',
    s35empty: '暂无资产。先在“2. 定时任务”里建,或去 dsh 对话说“新建 recipe”。',
    s35note: '说明:实验性 — 模型只检索已激活资产的有界摘要(默认 top 5 · 800 tokens 预算)。草稿需先真实回放成功才能激活。',
    s35mode: '自动化自由度', s35limit: '限流', s35limitV: 'minDelay 750ms / 并发 2 / 突发 3 / 冷却 30s',
    s35limitOn: '已启用', s35auth: '限域登录', s35authV: 'authProfiles: allowedDomains 限域,默认只读不回写',
    s35scripts: '脚本目录', s35scriptUrlPh: '脚本目标 URL(可空)', s35scriptRun: '运行内置脚本',
    s35crawlUrlPh: '要抓的 URL', s35crawlRun: '泛爬(单页提取)',
    s35mReadonly: '只读', s35mStandard: '标准(默认)', s35mAuto: '自主', s35mUnrest: '无人值守',
    s4t: '4. 你跟 dsh 说的话(这才是真正在用)',
    s4lead: '点下方蓝按钮 → 文本复制到剪贴板 + 自动新开 dsh 标签页 → 在 dsh 对话框按 Ctrl+V 粘上发送:',
    s4jumpT: '→ dsh 对话框(输入框 + 发送)', s4send: '→ 复制 + 打开 dsh',
    ...
    s4picksT: '常用快捷点(点一下填进输入框):', s4hint: '不知道说啥?点上面的快捷按钮 → 改改 → 点“→ 复制 + 打开 dsh” → 在 dsh 对话框 Ctrl+V 发送。',
    s4sent: '已复制 + 打开 dsh', s4empty: '输入框是空的', s4copyFail: '复制失败,请手动复制',
    s5t: '未检测到 opencli —— 三步接入',
    s6t: '6. 当前 dsh profile(用错 profile 找不到 opencli 工具)',
    s6profile: 'dsh profile', s6state: 'dsh-opencli 状态', s6mounted: '已挂载',
    s6ok: '正确', s6hint: '若切到 headless / zvecbtest / intelhubtest 等其它 profile,opencli 没挂载。切回 web:dsh --profile web。',
    s5done: '已经装好了,跳过', s5noop: '无需操作',
  ...
  en: {
    ...
    refresh: 'Refresh/Diagnose', diagnosing: 'Checking…', langName: '中文',
    s0t: '0. Try it', s0tag: 'Works now',
    s0hint: 'Not sure what to do? Hit “Run demo” — the panel really runs one command via try-run and shows the result.',
    s0demo: 'Run demo', s0run: 'Run', s0ph: 'Command to run, e.g.: site arxiv recent cs.AI',
    s05t: '0.5 Find a site', s05hint: 'Click a site tag to fill the search box; find a site name → copy the opencli command.',
    s05searchPh: 'Search sites, commands or descriptions', s05cmds: 'commands', s05empty: 'No matching site or command',
    s05call: 'Call in dsh session:', s05copyHint: '· click a row to copy the full command', s05disable: 'Disable', s05enable: 'Enable',
    s05disabled: 'Disabled', s05copied: 'Copied', s05loading: 'loading…', s05loadFail: 'Load failed',
    s05siteCmds: 'Site commands', s05appCmds: 'App commands',
    ...
    s06t: '0.6 Shortcuts', s06tag: 'New',
    s06diag: 'Failure diagnosis ?', s06skill: 'Install opencli skill', s06patch: 'Switch to Patchright',
    s06hon: 'Headless on', s06hoff: 'Headless off', s06ro: 'Switch to read-only', s06auto: 'Switch to autonomous',
    s06hint: 'Click a button → text copied to clipboard + dsh dialog opens; paste and send. Diagnosis pops up first.',
    s1t: '1. opencli health', s1tag: 'At a glance',
    s1daemon: 'daemon', s1running: 'Running', s1stopped: 'Not running',
    s1start: 'Start daemon', s1starting: 'Starting…', s1ext: 'Chrome extension',
    s1extOn: 'Connected', s1approval: 'write approval gate',
    s1approvalOn: 'On (site writes ask first)', s1approvalOff: 'Off',
    s1on: 'On', s1off: 'Off', s1loginCan: 'sites checkable', s1login: 'Login state',
    s1check: 'Check logins', s1checking: 'Checking…', s1collapse: 'Collapse',
    s1env: 'Environment', s1runtime: 'Runtime', s1mode: 'Automation level',
    s1sites: 'sites', s1cmds: 'commands', s1ver: 'v',
    s1okTag: 'Healthy', s1loginHint: 'green=logged in · yellow=timeout · red=not logged in · 5+ collapsed · to switch account tell dsh “switch weibo account”',
    s1timeout: 'Probe timeout', s1checkFail: 'Check failed',
    s2t: '2. Schedules', s2hint: 'Create/edit/delete → tell dsh “schedule arxiv briefings daily at 9am”',
    s2sitePh: 'site command (e.g.: zhihu hot)', s2cronPh: 'cron', s2create: 'Create',
    s2empty: 'No schedules yet. Fill site command + cron above, or ask in the dsh dialog. Then see them via dsh schedule list.',
    s2run: 'Run now', s2pause: 'Pause', s2resume: 'Resume', s2del: 'Delete',
    s2paused: 'Paused', s2on: 'Active', s2runOk: 'Triggered', s2hist: 'History: ask “schedule history” in the dsh dialog',
    s3t: '3. Record & replay', s3hint: 'Record new / edit → tell dsh “record: grab today’s arxiv AI papers”',
    s3start: 'Start recording', s3stop: 'Stop recording', s3namePh: 'Recording name (e.g.: daily zhihu hot)',
    s3stepPh: 'Add step (Enter to confirm, e.g.: site zhihu hot)', s3recorded: 'recorded',
    s3replay: 'Replay', s3del: 'Delete', s3promote: 'Promote to recipe',
    s3promoted: 'Promoted to recipe:', s3empty: 'No recordings. Hit “Start recording” and type steps; real Chrome actions append via the dsh dialog.',
    s3steps: 'steps', s35t: '3.5 Automation assets', s35tag: 'anweat parity',
    s35hint: 'New / activate / archive → tell dsh “new recipe”',
    s35searchPh: 'Search assets (e.g.: arxiv)', s35search: 'Search', s35run: 'Run',
    ...
    s35mode: 'Automation level', s35limit: 'Rate limit', s35limitV: 'minDelay 750ms / concurrency 2 / burst 3 / cooldown 30s',
    s35limitOn: 'Enabled', s35auth: 'Scoped login', s35authV: 'authProfiles: allowedDomains scoped, read-only by default',
    s35scripts: 'Script catalog', s35scriptUrlPh: 'Script target URL (optional)', s35scriptRun: 'Run builtin script',
    s35crawlUrlPh: 'URL to fetch', s35crawlRun: 'Crawl (single page)',
    s35mReadonly: 'read-only', s35mStandard: 'standard (default)', s35mAuto: 'autonomous', s35mUnrest: 'unrestricted',
    ...
    s4jumpT: '→ dsh dialog (input + send)', s4send: '→ Copy + open dsh',
    ...
    s4picksT: 'Quick picks (click to fill the input):', s4hint: 'Not sure what to say? Click a quick pick → edit → “→ Copy + open dsh” → Ctrl+V in the dsh dialog.',
    s4sent: 'Copied + dsh opened', s4empty: 'Input is empty', s4copyFail: 'Copy failed, please copy manually',
    s5t: 'opencli not detected — 3 steps to connect',
    s6t: '6. Current dsh profile (wrong profile hides opencli tools)',
    s6profile: 'dsh profile', s6state: 'dsh-opencli state', s6mounted: 'Mounted',
    s6ok: 'Correct', s6hint: 'If you switch to headless / zvecbtest / intelhubtest etc., opencli is not mounted. Switch back to web: dsh --profile web.',
    s5done: 'Already installed, skip', s5noop: 'No action needed',
    ...
    diagClose: 'Close', diagSend: 'Copy to dsh →',
...
interface SchedItem { id: string; site: string; cron: string; createdAt: string; enabled: boolean }
...
/* ── OpenCLIApp 设计令牌(0.1.38 实测) + v3.4 新增段落样式 ── */
const CSS = `
...
function Panel(): ReturnType<typeof createElement> {
  ...
  const [scriptList, setScriptList] = useState<BuiltinScript[] | null>(null)
  ...
  const sendToDsh = async (text: string, okMsg: string): Promise<void> => {
    const ok = await copyText(text)
    if (ok) {
      showToast(okMsg, true)
      try { window.open(DSH_URL, '_blank') } catch { /* 弹窗被拦则只复制 */ }
    } else {
  ...
  const runLoginCheck = async (): Promise<void> => {
    ...
    setLogin(r.ok && r.value !== undefined ? r.value : { ok: false, checkedAt: null, results: [], error: r.error?.message ?? t('errReq') })
    setChecking(false)
  }
  ...
  const toggle = async (name: string, el?: HTMLElement | null): Promise<void> => {
    ...
    if (details[name] === undefined) {
      ...
      setDetails((prev) => ({ ...prev, [name]: r.ok && r.value !== undefined ? r.value : { ok: false, name, domain: null, commands: [], error: r.error?.message ?? t('errReq') } }))
    }
  }
  ...
  const reload = async () => {
    ...
    else setStatus(st.value ?? { ok: false, bin: null, version: null, daemon: null, adapterSites: null, error: st.error?.message ?? 'status failed' })
  ...
  const picks = lang === 'zh'
    ? ['arxiv 搜最近 7 天 AI 综述', 'github trending 看 AI/ML 今日榜', 'hackernews 搜 deepseek',
       '每天9点跑 site arxiv search agent', '录一段:抓 arxiv 今天的 AI 论文到 Obsidian', '关掉所有定时',
       'huggingface 找最近 7 天大模型', '修改浏览器配置:切到 Playwright headless', '新建 recipe:批量索引 github issues']
    : ['arxiv: AI surveys from the last 7 days', 'github trending: today’s AI/ML chart', 'hackernews search deepseek',
       'run site arxiv search agent daily at 9am', 'record: grab today’s arxiv AI papers to Obsidian', 'pause all schedules',
       'huggingface: notable models of the last 7 days', 'browser config: switch to Playwright headless', 'new recipe: batch-index github issues']
  ...
  return createElement('div', { className: 'ocp' },
    ...
    createElement('div', { className: 'ocp-head' },
      ...
      createElement('div', { style: { minWidth: 0 } },
        createElement('div', { className: 'ocp-title' }, t('title')),
        createElement('div', { className: 'ocp-desc' }, t('desc')),
      ),
      createElement('div', { className: 'ocp-headbtns' },
        createElement('button', { className: 'ocp-btn', onClick: () => { setLang(lang === 'zh' ? 'en' : 'zh') } }, t('langName')),
        createElement('button', { className: 'ocp-btn', onClick: reload, disabled: busy }, busy ? t('diagnosing') : t('refresh')),
      ),
    ),

    // ── 0. 试试看(真跑 try-run)──
    createElement('div', { className: 'ocp-card ocp-demo', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s0t'), createElement('span', { className: 'ocp-tag ocp-tag-y' }, t('s0tag'))),
      createElement('div', { className: 'ocp-hint', style: { marginBottom: '8px' } }, t('s0hint')),
      createElement('div', { className: 'ocp-rowflex' },
        createElement('button', { className: 'ocp-btn ocp-btn-w', disabled: running, onClick: () => { void runDemo('site arxiv recent cs.AI') } }, running ? t('diagnosing') : t('s0demo')),
        createElement('input', { className: 'ocp-input ocp-input-sm', placeholder: t('s0ph'), value: runInput, onChange: (e: { target: { value: string } }) => setRunInput(e.target.value) }),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', disabled: running, onClick: () => { void runDemo(runInput) } }, t('s0run')),
      ),
      runOut !== null ? createElement('div', { className: 'ocp-runout' },
        createElement('div', { style: { color: '#9A9AA0', marginBottom: '4px' } }, `$ ${runOut.cmd}`),
        runOut.ok ? runOut.text : createElement('span', { style: { color: '#FF6B5E' } }, runOut.text),
      ) : null,
    ),
    ...
    missing ? createElement('div', { className: 'ocp-card ocp-setup' },
      createElement('div', { className: 'ocp-setup-head', onClick: () => { setSetupOpen(!setupOpen) } },
        createElement('span', { className: 'ocp-setup-t' }, t('s5t')),
    ...
    // ── 1. 健康 + 登录态 chips + 运行时 ──
    status !== null && status.ok ? createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s1t'),
        createElement('span', { className: `ocp-tag ${up && ext ? 'ocp-tag-g' : 'ocp-tag-y'}` }, up && ext ? t('s1okTag') : `${t('s1daemon')}:${up ? t('s1running') : t('s1stopped')}`),
      ),
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: `ocp-dot ${up ? 'ocp-ok' : 'ocp-bad'}` }),
        createElement('span', { className: 'ocp-sk' }, 'opencli'),
        createElement('span', { className: 'ocp-sv ocp-mono', style: { fontSize: 12 } }, `${t('s1ver')}${status.version ?? '?'}`),
        createElement('span', { className: 'ocp-dot', style: { marginLeft: '8px', background: up ? '#34C759' : '#FF453A' } }),
        createElement('span', { className: 'ocp-sk' }, t('s1daemon')),
        createElement('span', { className: 'ocp-sv' }, up ? t('s1running') : t('s1stopped')),
        createElement('span', { className: 'ocp-dot', style: { marginLeft: '8px', background: ext ? '#34C759' : '#FF453A' } }),
        createElement('span', { className: 'ocp-sk' }, t('s1ext')),
        createElement('span', { className: 'ocp-sv' }, ext ? t('s1extOn') : (d?.extension ?? '未知')),
        up ? null : createElement('button', {
          className: 'ocp-btn ocp-btn-sm', disabled: starting,
          onClick: () => { void startDaemon() },
        }, starting ? t('s1starting') : t('s1start')),
        daemonMsg !== null ? createElement('span', { className: 'ocp-err' }, daemonMsg) : null,
      ),
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-sk' }, t('s1approval')),
        createElement('span', { className: 'ocp-sv' }, settings === null ? '…' : (settings.approvalOn ? t('s1approvalOn') : t('s1approvalOff'))),
        createElement('button', {
          className: 'ocp-btn ocp-btn-sm', onClick: () => { void setApproval(!(settings?.approvalOn ?? true)) },
        }, settings?.approvalOn === false ? t('s1on') : t('s1off')),
      ),
      whoamiCount > 0 || login !== null ? createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-sk' }, t('s1login')),
        login === null
          ? createElement('span', { className: 'ocp-sv' }, `${whoamiCount} ${t('s1loginCan')}`)
          : createElement('div', { className: 'ocp-chips' },
              loginOk.slice(0, 5).map((r) => createElement('span', { key: r.site, className: 'ocp-chip', title: r.detail ?? '' },
                createElement('span', { className: 'ocp-dot ocp-ok' }), r.site)),
              loginWarn.slice(0, 2).map((r) => createElement('span', { key: r.site, className: 'ocp-chip ocp-chip-y' },
                createElement('span', { className: 'ocp-dot', style: { background: '#FF9F0A' } }), `${r.site} (${t('s1timeout')})`)),
              loginBad.slice(0, 2).map((r) => createElement('span', { key: r.site, className: 'ocp-chip ocp-chip-r' },
                createElement('span', { className: 'ocp-dot ocp-bad' }), r.site)),
              (login?.results ?? []).length > 9 ? createElement('details', { style: { display: 'inline' } } as unknown as Record<string, unknown>,
                createElement('summary', { style: { fontSize: '11px' } }, `+ ${(login?.results ?? []).length - 9}`),
                createElement('div', { className: 'ocp-login' },
                  (login?.results ?? []).slice(9).map((r) =>
                    createElement('div', { key: r.site, className: 'ocp-lrow', title: r.detail ?? '' },
                      ...
                      createElement('span', { className: 'ocp-ldetail' }, r.timedOut ? t('s1timeout') : (r.detail ?? '')),
                    ),
                  ),
                ),
              ) : null,
        ...
        }, checking ? t('s1checking') : t('s1check')),
        login !== null ? createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { setLogin(null) } }, t('s1collapse')) : null,
      ) : null,
      login !== null && !login.ok ? createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-err' }, login.error ?? t('s1checkFail')),
      ) : null,
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-sk' }, t('s1runtime')),
        createElement('span', { className: 'ocp-sv ocp-mono', style: { fontSize: 12 } },
          `${status.adapterSites ?? adapters?.length ?? '?'} ${t('s1sites')}`,
          ` · ${(siteCmds + appCmds)} ${t('s1cmds')}`,
          d?.port !== undefined ? ` · :${d.port}` : '',
          d?.uptime !== undefined ? ` · ↑ ${d.uptime}` : '',
        ),
        createElement('span', { className: 'ocp-sk', style: { marginLeft: '8px' } }, t('s1mode')),
        createElement('span', { className: 'ocp-code' }, autoMode),
      ),
      createElement('div', { className: 'ocp-hint', style: { padding: '6px 0 8px' } }, t('s1loginHint')),
    ) : null,

    // ── 0.6 实用快捷 ──
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s06t'), createElement('span', { className: 'ocp-tag' }, t('s06tag'))),
      createElement('div', { className: 'ocp-rowflex' },
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { setDiagOpen(true) } }, t('s06diag')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,装 opencli skill' : 'dsh assistant, install the opencli skill', t('s4sent')) } }, t('s06skill')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,修改浏览器配置:切到 Patchright' : 'dsh assistant, browser config: switch to Patchright', t('s4sent')) } }, t('s06patch')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,修改浏览器配置:开 headless' : 'dsh assistant, browser config: headless on', t('s4sent')) } }, t('s06hon')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,修改浏览器配置:关 headless' : 'dsh assistant, browser config: headless off', t('s4sent')) } }, t('s06hoff')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,修改自动化档:切到 read-only' : 'dsh assistant, automation level: read-only', t('s4sent')) } }, t('s06ro')),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void sendToDsh(lang === 'zh' ? 'dsh 助手,修改自动化档:切到 autonomous' : 'dsh assistant, automation level: autonomous', t('s4sent')) } }, t('s06auto')),
      ),
      createElement('div', { className: 'ocp-hint', style: { marginTop: '8px' } }, t('s06hint')),
    ),

    // 失败诊断弹窗
    diagOpen ? createElement('div', { className: 'ocp-modal-bg', onClick: () => { setDiagOpen(false) } },
      createElement('div', { className: 'ocp-modal', onClick: (e: Event) => { e.stopPropagation() } },
        createElement('div', { className: 'ocp-modal-t' }, t('diagT')),
        createElement('div', { className: 'ocp-modal-b' },
          createElement('div', null, createElement('span', { className: 'ocp-num' }, '1. '), t('diag1')),
          createElement('div', null, createElement('span', { className: 'ocp-num' }, '2. '), t('diag2')),
          createElement('div', null, createElement('span', { className: 'ocp-num' }, '3. '), t('diag3')),
          createElement('div', null, createElement('span', { className: 'ocp-num' }, '4. '), t('diag4')),
          createElement('div', null, createElement('span', { className: 'ocp-num' }, '5. '), t('diag5')),
        ),
        createElement('div', { className: 'ocp-modal-f' },
          createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { setDiagOpen(false) } }, t('diagClose')),
          createElement('button', {
            className: 'ocp-btn ocp-btn-sm ocp-btn-p', onClick: () => {
              setDiagOpen(false)
    ...
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, `${t('s2t')} `, createElement('span', { className: 'ocp-tag' }, String(schedules.length))),
      createElement('div', { className: 'ocp-hint', style: { marginBottom: '8px' } }, t('s2hint')),
      schedules.length > 0
        ? createElement('div', null, schedules.map((s) =>
            createElement('div', { key: s.id, className: `ocp-sched ${s.enabled ? '' : 'off'}` },
              createElement('button', {
                className: `ocp-sw ${s.enabled ? 'ocp-sw-on' : ''}`, title: s.enabled ? t('s2pause') : t('s2resume'),
                onClick: () => { void toggleSchedule(s.id, !s.enabled) },
              }),
              createElement('span', { className: 'ocp-sname2' }, s.site),
              createElement('span', { className: `ocp-tag ${s.enabled ? 'ocp-tag-g' : ''}` }, s.enabled ? t('s2on') : t('s2paused')),
              createElement('span', { className: 'ocp-meta' }, `cron: ${s.cron} · ${s.createdAt}`),
              createElement('span', { style: { marginLeft: 'auto', display: 'flex', gap: '6px' } },
                createElement('button', { className: 'ocp-btn ocp-btn-sm ocp-btn-w', onClick: () => { void runScheduleNow(s.id) } }, t('s2run')),
                createElement('button', { className: 'ocp-btn ocp-btn-sm ocp-btn-d', onClick: () => { void removeSchedule(s.id) } }, t('s2del')),
              ),
            ),
          ))
        : createElement('div', { className: 'ocp-hint', style: { padding: '6px 0' } }, t('s2empty')),
      createElement('div', { className: 'ocp-srow' },
        createElement('input', { className: 'ocp-input ocp-input-sm', style: { flex: 1 }, placeholder: t('s2sitePh'), value: scheduleSite, onChange: (e: { target: { value: string } }) => setScheduleSite(e.target.value) }),
        createElement('input', { className: 'ocp-input ocp-input-sm', style: { width: '130px', flex: 'none' }, placeholder: t('s2cronPh'), value: scheduleCron, onChange: (e: { target: { value: string } }) => setScheduleCron(e.target.value) }),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', disabled: schedBusy, onClick: () => { void addSchedule() } }, t('s2create')),
      ),
      createElement('div', { className: 'ocp-hint', style: { paddingBottom: '8px' } }, t('s2hist')),
    ),

    // ── 3. 录制回放 ──
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-srow', style: { paddingBottom: '10px' } },
        createElement('span', { className: 'ocp-setup-t' }, `${t('s3t')} `),
        createElement('span', { className: 'ocp-tag' }, `${recordings.length}`),
        createElement('span', { className: 'ocp-hint' }, t('s3hint')),
        createElement('span', { style: { marginLeft: 'auto' } },
          createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { if (isRecording) stopRecording(); else startRecording() } }, isRecording ? t('s3stop') : t('s3start')),
        ),
      ),
      isRecording ? createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: '8px' } },
        createElement('div', { className: 'ocp-srow' },
          createElement('input', { className: 'ocp-input ocp-input-sm', placeholder: t('s3namePh'), value: recordName, onChange: (e: { target: { value: string } }) => setRecordName(e.target.value) }),
          createElement('span', { className: 'ocp-hint' }, `${t('s3recorded')} ${recordSteps.length}`),
        ),
        createElement('div', { className: 'ocp-srow' },
          createElement('input', {
            className: 'ocp-input ocp-input-sm', placeholder: t('s3stepPh'),
      ...
      recordings.length > 0 ? createElement('div', { style: { display: 'flex', flexDirection: 'column', marginTop: '4px' } },
        recordings.slice(0, 5).map((r) => createElement('div', { key: r.id, className: 'ocp-sched' },
          createElement('span', { className: 'ocp-sname2', style: { fontSize: '12px' } }, r.name),
          createElement('span', { className: 'ocp-hint' }, `${r.steps.length}${t('s3steps')} · ${new Date(r.createdAt).toLocaleDateString()}`),
          createElement('span', { style: { marginLeft: 'auto', display: 'flex', gap: '6px' } },
            createElement('button', { className: 'ocp-btn ocp-btn-sm ocp-btn-w', onClick: () => { void replayRecording(r.id) } }, t('s3replay')),
            createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void promoteRecording(r.id) } }, t('s3promote')),
            createElement('button', { className: 'ocp-btn ocp-btn-sm ocp-btn-d', onClick: () => { persistRecordings(recordings.filter((x) => x.id !== r.id)) } }, t('s3del')),
          ),
        )),
      ) : createElement('div', { className: 'ocp-hint', style: { padding: '8px 0' } }, t('s3empty')),
    ),

    // ── 3.5 自动化资产库 ──
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s35t'), createElement('span', { className: 'ocp-tag' }, t('s35tag'))),
      createElement('div', { className: 'ocp-hint', style: { marginBottom: '8px' } }, t('s35hint')),
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-sk' }, t('s35mode')),
        createElement('select', {
          ...
          createElement('option', { value: 'read-only' }, t('s35mReadonly')),
          createElement('option', { value: 'standard' }, t('s35mStandard')),
          createElement('option', { value: 'autonomous' }, t('s35mAuto')),
          createElement('option', { value: 'unrestricted' }, t('s35mUnrest')),
        ),
        createElement('span', { className: 'ocp-sk', style: { marginLeft: '8px' } }, t('s35limit')),
        createElement('span', { className: 'ocp-hint' }, t('s35limitV')),
        createElement('span', { className: 'ocp-tag ocp-tag-read', style: { marginLeft: 'auto' } }, t('s35limitOn')),
      ),
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-sk' }, t('s35auth')),
        createElement('span', { className: 'ocp-hint' }, t('s35authV')),
      ),
      createElement('div', { className: 'ocp-srow' },
        createElement('input', { className: 'ocp-input ocp-input-sm', style: { flex: 1 }, placeholder: t('s35searchPh'), value: assetQuery, onChange: (e: { target: { value: string } }) => setAssetQuery(e.target.value) }),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', disabled: assetBusy, onClick: () => { void searchAssets(assetQuery) } }, assetBusy ? t('diagnosing') : t('s35search')),
      ),
      assetHits === null
        ? createElement('div', { className: 'ocp-hint', style: { padding: '6px 0' } }, t('s35empty'))
        : assetHits.length === 0
          ? createElement('div', { className: 'ocp-hint', style: { padding: '6px 0' } }, t('s35empty'))
          : createElement('div', null, assetHits.map((h) =>
              createElement('div', { key: h.id, className: 'ocp-sched' },
                createElement('span', { className: 'ocp-sname2', style: { fontSize: '12px' } }, h.name),
                createElement('span', { className: 'ocp-hint ocp-mono' }, h.id),
                createElement('span', { style: { marginLeft: 'auto' } },
                  createElement('button', { className: 'ocp-btn ocp-btn-sm ocp-btn-w', onClick: () => { void runAsset(h.id) } }, t('s35run')),
                ),
              ),
            )),
      createElement('div', { className: 'ocp-srow' },
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void loadScripts() } }, t('s35scripts')),
        createElement('input', { className: 'ocp-input ocp-input-sm', style: { flex: 1 }, placeholder: t('s35scriptUrlPh'), value: scriptUrl, onChange: (e: { target: { value: string } }) => setScriptUrl(e.target.value) }),
      ),
      scriptList !== null ? createElement('div', null, scriptList.map((s) =>
        createElement('div', { key: s.name, className: 'ocp-sched' },
          createElement('span', { className: 'ocp-cname' }, s.name),
          createElement('span', { className: 'ocp-hint' }, s.description),
          createElement('span', { style: { marginLeft: 'auto' } },
            createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void runBuiltin(s.name) } }, t('s35scriptRun')),
          ),
        ),
      )) : null,
      scriptMsg !== null ? createElement('div', { className: 'ocp-runout', style: { marginTop: '6px', maxHeight: '160px' } }, scriptMsg) : null,
      createElement('div', { className: 'ocp-srow' },
        createElement('input', { className: 'ocp-input ocp-input-sm', style: { flex: 1 }, placeholder: t('s35crawlUrlPh'), value: crawlUrl, onChange: (e: { target: { value: string } }) => setCrawlUrl(e.target.value) }),
        createElement('button', { className: 'ocp-btn ocp-btn-sm', onClick: () => { void runCrawl() } }, t('s35crawlRun')),
      ),
      crawlMsg !== null ? createElement('div', { className: 'ocp-hint', style: { paddingBottom: '6px' } }, crawlMsg) : null,
      createElement('div', { className: 'ocp-hint', style: { paddingBottom: '8px' } }, t('s35note')),
    ),

    // ── 4. 跳到 dsh 对话框 ──
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s4t')),
      createElement('div', { className: 'ocp-hint', style: { marginBottom: '8px' } }, t('s4lead')),
      createElement('div', { className: 'ocp-jump' },
        createElement('div', { className: 'ocp-jump-t' }, t('s4jumpT')),
        createElement('div', { className: 'ocp-rowflex' },
          createElement('input', { className: 'ocp-input ocp-input-sm', style: { flex: 1 }, placeholder: t('s4ph'), value: msgInput, onChange: (e: { target: { value: string } }) => setMsgInput(e.target.value) }),
          createElement('button', {
            className: 'ocp-btn ocp-btn-sm ocp-btn-p', style: { height: '36px' },
            onClick: () => {
              const text = msgInput.trim()
              if (!text) { showToast(t('s4empty'), false); return }
              void sendToDsh(text, t('s4sent'))
            },
          }, t('s4send')),
        ),
        createElement('div', { className: 'ocp-hint', style: { marginTop: '10px' } }, t('s4jumpHint')),
      ),
      createElement('div', { className: 'ocp-hint', style: { marginTop: '10px', marginBottom: '6px' } }, t('s4picksT')),
      createElement('div', { style: { display: 'flex', flexWrap: 'wrap', gap: '2px' } },
        picks.map((p) => createElement('button', { key: p, className: 'ocp-pick', onClick: () => { setMsgInput(p) } }, p)),
      ),
      createElement('div', { className: 'ocp-hint', style: { marginTop: '8px', paddingBottom: '6px' } }, t('s4hint')),
    ),

    // ── 已安装:一行确认(无需操作)──
    !missing && status !== null && status.ok ? createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-dot ocp-mid' }),
        createElement('span', { className: 'ocp-sv' }, t('s5done')),
        createElement('span', { className: 'ocp-code' }, `opencli ${status.version ?? '?'}`),
        createElement('span', { className: 'ocp-code' }, `daemon ${up ? t('s1running') : t('s1stopped')}`),
        createElement('span', { className: 'ocp-code' }, `extension ${d?.extension ?? '?'}`),
        createElement('span', { className: 'ocp-tag ocp-tag-g', style: { marginLeft: 'auto' } }, t('s5noop')),
      ),
      createElement('div', { className: 'ocp-hint', style: { paddingBottom: '8px' } }, t('s5hint')),
    ) : null,

    // ── 6. 当前 dsh profile ──
    createElement('div', { className: 'ocp-card', style: { padding: '12px 18px' } },
      createElement('div', { className: 'ocp-sect' }, t('s6t')),
      createElement('div', { className: 'ocp-srow' },
        createElement('span', { className: 'ocp-dot ocp-ok' }),
        createElement('span', { className: 'ocp-sk' }, t('s6profile')),
        createElement('span', { className: 'ocp-sv ocp-mono' }, 'web'),
        createElement('span', { className: 'ocp-sk', style: { marginLeft: '8px' } }, t('s6state')),
        createElement('span', { className: 'ocp-sv', style: { color: '#4DDB7A', fontWeight: 600 } }, t('s6mounted')),
        createElement('span', { className: 'ocp-tag ocp-tag-g', style: { marginLeft: 'auto' } }, t('s6ok')),
      ),
      createElement('div', { className: 'ocp-hint', style: { paddingBottom: '8px' } }, t('s6hint')),
    ),

    // ── 0.5 命令集合(对齐 App 同名页面;真数据)──
    adapters !== null ? createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
      createElement('div', { className: 'ocp-sect' }, t('s05t'), createElement('span', { className: 'ocp-tag' }, `${siteCmds + appCmds}`)),
      createElement('div', { className: 'ocp-chips', style: { marginBottom: '-4px' } },
        siteList.slice(0, 8).map((a) => createElement('button', {
          key: a.name, className: 'ocp-pick', title: `${a.commandCount}`,
          onClick: () => { setTab('site'); setQuery(a.name); setExpanded(null) },
        }, `${a.name} · ${a.commandCount}`)),
      ),
      createElement('div', { className: 'ocp-hint' }, t('s05hint')),
      createElement('div', { className: 'ocp-tabs' },
        createElement('button', {
          className: `ocp-tab ${tab === 'site' ? 'ocp-tab-on' : ''}`, title: t('s05siteTitle'),
          onClick: () => { setTab('site'); setExpanded(null) },
        }, t('s05siteCmds'), createElement('b', null, String(siteCmds))),
        createElement('button', {
          className: `ocp-tab ${tab === 'app' ? 'ocp-tab-on' : ''}`,
          title: t('s05appTitle'),
          onClick: () => { setTab('app'); setExpanded(null) },
        }, t('s05appCmds'), createElement('b', null, String(appCmds))),
      ),
      createElement('div', { className: 'ocp-search' },
        createElement('input', { className: 'ocp-input', placeholder: t('s05searchPh'), value: query, onChange: (e: { target: { value: string } }) => setQuery(e.target.value) }),
        createElement('span', { className: 'ocp-count' }, createElement('b', null, String(q.length > 0 ? filtered.length : (tab === 'site' ? siteCmds : appCmds))), ` ${t('s05cmds')}`),
      ),
        ...
        filtered.slice(0, 200).map((a) => {
          ...
          return createElement('div', {
            ...
            createElement('div', { className: 'ocp-siterow' },
              ...
              a.disabled === true ? createElement('span', { className: 'ocp-badge-dis' }, t('s05disabled')) : null,
            ...
            open ? createElement('div', { className: 'ocp-cmds', onClick: (e: Event) => { e.stopPropagation() } },
              createElement('div', { className: 'ocp-cmdhint' },
                createElement('span', null, t('s05call')),
                createElement('span', { className: 'ocp-code' }, `site ${a.name} <命令>`),
                createElement('span', null, t('s05copyHint')),
                createElement('button', {
                  className: 'ocp-btn ocp-btn-sm', style: { marginLeft: 'auto' },
                  onClick: () => { void toggleDisable(a.name, a.disabled !== true) },
                }, a.disabled === true ? t('s05enable') : t('s05disable')),
              ),
              detail === undefined
                ? createElement('div', { className: 'ocp-load' }, t('s05loading'))
                : detail.ok
                  ? detail.commands.map((c) => {
                      ...
                      return createElement('div', {
                        ...
                        justCopied ? createElement('span', { className: 'ocp-copied' }, t('s05copied')) : null,
                      )
                    })
                  : createElement('div', { className: 'ocp-err' }, detail.error ?? t('s05loadFail')),
            ) : null,
          )
        }),
        filtered.length === 0 ? createElement('div', { className: 'ocp-load' }, t('s05empty')) : null,
      ),
    ) : null,

    // toast
    toast !== null ? createElement('div', {
      className: 'ocp-toast', style: { background: toast.ok ? '#4DDB7A' : '#FF453A' },
    }, toast.msg) : null,
  )
}
